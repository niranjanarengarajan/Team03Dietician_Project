...
public class EditPatient_Step {
	...
	public void user_should_see_on_the_dialog_box(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void user_clears_existing_value_in_of_edit_patient_dialogue_box(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("User should see placeholder text is {string}")
	public void user_should_see_placeholder_text_is(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("User clicks the {string} button after entering valid data from Excel for {string} edit window")
	public void user_clicks_the_button_after_entering_valid_data_from_excel_for_edit_window(String string, String string2) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
...
//	}
	...
	@Then("User should see updated values from Excel for {string} in ViewTestReport page")
	public void user_should_see_updated_values_from_excel_for_in_view_test_report_page(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("User clicks {string} button after entering invalid data from Excel to Edit {string} edit window")
	public void user_clicks_button_after_entering_invalid_data_from_excel_to_edit_edit_window(String string, String string2) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
