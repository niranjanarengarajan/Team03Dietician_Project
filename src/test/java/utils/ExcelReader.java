...
public class ExcelReader {
	...
	public static List<Map<String, String>> readDataFromExcel(String sheetName) {
		...
		try (FileInputStream fis = new FileInputStream(prop.getProperty("excelpath"));
			...
			throw new RuntimeException("Error reading Excel file: " + prop.getProperty("excelpath"), e);
		}
