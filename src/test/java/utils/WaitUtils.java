...
public class WaitUtils {
	...
	public void waitForUrlContains(WebDriver driver, String fragment, int timeoutSeconds) {
		new WebDriverWait(driver, Duration.ofSeconds(timeoutSeconds)).until(ExpectedConditions.urlContains(fragment));
	}
	...
	public String getVisibleText(WebDriver driver, WebElement element, int timeoutSeconds) {
		return waitForVisibility(driver, element, timeoutSeconds).getText().trim();
	}

	public boolean isVisible(WebDriver driver, WebElement element, int timeoutSeconds) {
		try {
